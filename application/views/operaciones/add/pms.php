 ...
 <!-- Content Header (Page header) -->
    ...
    <?php
  echo form_open('Operaciones/agregar_pms');
  ?>
  <div class="row">
    <div class="col-xs-8">
              ...
              <div class="row">                
                <div class="col-md-3">
                    <div class="form-group">
                        <input class="form-control" type="text" name="nombre_pm" id="nombre_pm" placeholder="Nombre PM">
                      </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                        <?php
                            echo form_dropdown('id_area',$areas,'',array('class' => 'form-control'));
                          ?>
                      </div>
                </div>
