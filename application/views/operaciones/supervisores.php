            ...
            <div class="box-body">
              ...
              <table id="postulantes" class="table table-bordered table-hover">
                ...
                if(!empty($supervisores)) {
                    foreach($supervisores as $p){ ?>
                        <tr>
                          <td><?php echo $p['cartera'] ?></td>
                          <td><?php echo $p['nombre_supervisor'] ?></td>   
                          <td>
                              <?php if(isset($p['nombre_supervisor'])){?>
                              <a class="btn btn-xs btn-warning" href="<?php echo base_url('index.php/operaciones/editar_supervisores/'.$p['id_cartera'])?>">Editar</a>
                              <?php }else{?>
                              <a class="btn btn-xs btn-primary" href="<?php echo base_url('index.php/operaciones/ingresar_supervisores/'.$p['id_cartera'])?>">Ingresar</a>
                              <?php }?>  
                          </td>
                        </tr>
                        <?php
