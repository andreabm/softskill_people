            ...
            <div class="box-body">
              ...
              <table id="ejecutivo" class="table table-bordered table-hover">
                ...
                <tr>
                  ...
                  <th>Rut</th>
                  <th>Nombre</th>
                  <th>Asistencia supervisor (<?php echo date('m-Y')?>)</th>
                ...
                if(!empty($contratados)) {
                    foreach($contratados as $p) {
                        ...
                        <tr>
                          ...
                          <td><?php echo form_dropdown('id_motivo_ausencia['.$p['rut'].']',$asistencia,$p['ultima_asistencia'],array('class' => 'form-control','disabled' => true));?></td>
                          <td><?php echo form_dropdown('id_motivo_ausencia['.$p['rut'].']',$asistencia,$p['ultima_asistencia'],array('class' => 'form-control'));?></td>
                          <td><input type="text" class="form-control" placeholder="Observacion" name="observacion[<?php echo $p['rut'] ?>]" value="<?php echo $p['ultima_observacion_asistencia'] ?>"></td>
