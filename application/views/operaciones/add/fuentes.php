 ...
 <!-- Content Header (Page header) -->
    ...
    <?php echo form_open('Operaciones/agregar_fuente');?>
  <div class="row">
    <div class="col-xs-8">
        ...
        <div class="col-xs-12">
            <div class="box box-success">
                <div class="box-header">
                  <h3 class="box-title">Datos Fuente</h3>
              </div>
              <div class="box-body">
              ...
              <div class="row">                
                <div class="col-md-3">
                    <div class="form-group">
                        <input class="form-control" type="text" name="nombre_fuente" id="nombre_fuente" placeholder="Nombre Fuente">
                      </div>
                </div>
