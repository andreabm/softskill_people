            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    foreach($aspectos_escuchas_items as $i){
                            ...
                            <?php 
                                  //echo $i['id_item_aspecto'].'<br/>';
                                  //echo 'accedo: '.$respondido_q[$i['id_item_aspecto']]['id_aspecto_items'].'<br/>';
            ...
            <div class="box box-danger">
                ...
                <div class="box-body">
                     <div class="form-group has-error">
                      <input type="text" id="total_general" name="total_general" class="form-control" value="<?php echo $respondido_r[0]['resultado_final_calidad'];?>" readonly>
                    </div> 
                </div>
            </div>
        </div>
...
<div class="row">
  <div class="col-md-10"></div>
      ...
      <div class="col-md-1 pull-right">
           <button type="button" class="btn btn-info" onclick="window.location.href='<?php echo base_url('index.php/calidad/escuchas_ejecutivos');?>'">Volver</button>           
      </div>
 </div>
