                    ...
                    <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="rut_audio" name="rut_audio" id="rut_audio" value="" autocomplete="off" onkeyup="texto_rut(event);" required>                           
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                           ...
                           <?php  }
                             ...
                             <tr>
                              ...
                              <td>
                                  ...
                                  <input type="hidden" name="nparcial<?=$a['id_aspecto'];?>" id="nparcial<?=$a['id_aspecto'];?>" class="form-control" value="" readonly>
