 ...
 <!-- Content Header (Page header) -->
    ...
    <div class="row">
        ...
        <form action="<?php echo base_url("/index.php/operaciones/agregar_pms");?>">
        <div class="col-md-3">
            <button type="submit" class="btn btn-block btn-info" >Agregar Pms</button>
        </div>
        </form>
    </div>
    <br />
        ...
        <div class="col-xs-12">
          <div class="box box-primary">
            <div class="box-header">
              <h3 class="box-title">Listado de Pms</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              ...
              <table id="postulantes" class="table table-bordered table-hover">
                ...
                if(!empty($pms)) {
                    foreach($pms as $p) {
                        ?>
                        <tr>
                          <td><?php echo $p['nombre_pm'] ?></td>
                          <td><?php echo $p['area'] ?></td>
                          <td><?php echo $p['gerencia'] ?></td>                          
                          <td>                              
                              <a class="btn btn-xs btn-warning" href="<?php echo base_url('index.php/operaciones/editar_pm/'.$p['id_pm'])?>">Editar</a>                              
                          </td>
                        </tr>
                        <?php
                    }
