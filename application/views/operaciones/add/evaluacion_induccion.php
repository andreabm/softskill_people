...
//paso a paso fin
  ...
  <div class="box box-success">
      <div class="box-body">
       ...
       if(isset($evaluacion_resp[0]['estado'])==1){?> 
       <h3 align='center'>La encuesta ya se encuentra realizada por el ejecutivo, favor validar en <a href="<?php echo base_url('/index.php/operaciones/induccion_ejecutivos');?>">Evaluaciones->Inducci&oacute;n Calidad</a>.</h3>
       <?php }else{?>
...
<div class="stepwizard col-md-offset-3">
    <div class="stepwizard-row setup-panel">
        ...
        <div class="stepwizard-step">
          <a href="#step-<?=$contador?>" style="pointer-events: none;" type="button" class="btn btn-<?php if($contador==1){echo 'primary';}else{echo 'default';}?> btn-circle" <?php if($contador != 1){echo 'disabled="disabled"';}?>><?=$contador?></a>
        </div>
        <?php 
        $contador = $contador + 1;
      }?>
    ...
    <div class="row setup-content" id="step-<?=$contador?>">
      <div class="col-md-6 col-md-offset-3">
          ...
          <div class="col-md-12">
            ...
            <input type="hidden" name="id_evaluacion<?=$contador?>" id="id_evaluacion" value="<?php echo $a->id_evaluacion_induccion;?>" readonly/>
            ...
            <table class="table table-condensed">
                    ...
                    <?php
                            ...
                            <tr>
                              ...
                              <?php }else{?>
                              <td width="16%">
                                <input type="radio" name="opcion<?=$a->id_evaluacion_induccion;?>" id="opcion" value="<?php if($i->correcto==1){echo $a->peso;}else{echo '0';}?>" onclick="seleccionado('item_sel<?=$a->id_evaluacion_induccion;?>','<?= $i->id_evaluacion_induccion_item;?>','continuar<?php echo $a->id_evaluacion_induccion;?>');" required="required">
                              </td>
                              <?php }?>
                              <td width="9%">
                              ...
                              <?php if($i->tipo=='T'){?>
                              <textarea class="form-control pull left" name="observacion<?= $i->id_evaluacion_induccion;?>" row="5" id="observacion<?= $i->id_evaluacion_induccion;?>" required="required" onkeyup="seleccionado('item_sel<?=$a->id_evaluacion_induccion;?>','<?= $i->id_evaluacion_induccion_item;?>','continuar<?php echo $a->id_evaluacion_induccion;?>');">&nbsp;</textarea>
                              <?php }else{
                                echo $i->opcion;
                              }?>
            ...
            */?>
            ...
            <?php }else{
             if($contador!=1){?>
            <button class="btn btn-primary prevBtn btn-md pull-left" type="button" >Volver</button>
            <?php }?>
