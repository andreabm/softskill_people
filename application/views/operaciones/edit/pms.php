...
$(document).ready(function() {
    ...
    <?php
  echo form_open('operaciones/editar_pm');
  ?>
  <div class="row">
    <div class="col-xs-8">
        ...
        <div class="col-xs-12">
            <div class="box box-success">
                <div class="box-header">
                  <h3 class="box-title">Datos Pm</h3>
              </div>
              <div class="box-body">
              ...
              <div class="row">                
                <div class="col-md-3">
                    <div class="form-group">
                      <input type="hidden" value="<?php echo $pm[0]['id_pm'];?>" name="id_pm" id="id_pm" class="form-control" />
                        <input class="form-control" type="text" name="nombre_pm" id="nombre_pm" value="<?php echo $pm[0]['nombre_pm'];?>" placeholder="Nombre PM">
                      </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                        <?php
                            echo form_dropdown('id_area',$areas,$pm[0]['id_area'],array('class' => 'form-control'));
                          ?>
                      </div>
                </div>
